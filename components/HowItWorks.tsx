const steps = [
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 21H5a2 2 0 01-2-2V7l5-5h11a2 2 0 012 2v14a2 2 0 01-2 2z" />
...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="bg-[#0C0C0C] py-28 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative flex flex-col gap-4">
          {/* Vertical line */}
          <div className="absolute left-[22px] top-12 bottom-12 w-px bg-gradient-to-b from-[#E8231A]/30 via-[#E8231A]/10 to-transparent hidden sm:block" />

          {steps.map((step, i) => (
            <div key={i} className="group flex gap-5 items-start">
              <div className="relative flex-shrink-0 w-11 h-11 rounded-full border border-[#E8231A]/30 bg-[#E8231A]/8 flex items-center justify-center z-10 group-hover:bg-[#E8231A]/20 group-hover:border-[#E8231A]/60 transition-all duration-300">
                <span className="text-[#E8231A]">{step.icon}</span>
              </div>
              <div className="shine flex-1 bg-[#111111] border border-white/[0.06] rounded-2xl p-5 sm:p-6 group-hover:border-white/10 transition-all duration-300 group-hover:-translate-y-0.5">
