  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0A0A0A] pt-20">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[700px] bg-[#C9A84C]/[0.06] rounded-full blur-[180px]" />
        <div className="absolute top-1/3 left-1/4 w-[600px] h-[600px] bg-[#D4AF37]/[0.04] rounded-full blur-[140px]" />
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-[#E8C878]/[0.03] rounded-full blur-[140px]" />
        {/* Grid */}
        <div
      ...
      {/* Floating orbs */}
      <div className="absolute top-24 right-16 w-3 h-3 bg-[#C9A84C] rounded-full opacity-60 animate-float blur-[1px]" />
      <div className="absolute top-40 left-20 w-2 h-2 bg-[#E8C878] rounded-full opacity-50 animate-float delay-300" />
      <div className="absolute bottom-32 right-32 w-2 h-2 bg-[#D4AF37] rounded-full opacity-40 animate-float delay-500" />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] pointer-events-none opacity-[0.04]">
        <div className="w-full h-full rounded-full border border-[#C9A84C] animate-spin-slow" />
      </div>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[950px] h-[950px] pointer-events-none opacity-[0.02]">
        <div className="w-full h-full rounded-full border border-[#D4AF37]" style={{ animation: 'rotate-slow 40s linear infinite reverse' }} />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="animate-fadeUp delay-100 text-5xl sm:text-6xl lg:text-[80px] font-extrabold text-white leading-[1.02] tracking-[-0.03em] mb-6">
          Get featured in{' '}
          <span className="text-gradient">trusted media.</span>
          <br />
          <span className="text-white/90">Build lasting authority.</span>
        </h1>

        {/* Subheadline */}
        <p className="animate-fadeUp delay-200 text-lg sm:text-xl text-white/40 max-w-2xl mx-auto mb-12 leading-[1.75] font-normal">
          PrimePressPro helps founders, startups, and agencies create media-ready
          content, track placements, and build credibility that AI search engines
          recognize — all from <span className="text-white/65">one dashboard.</span>
        </p>

        {/* CTAs */}
        <div className="animate-fadeUp delay-300 flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <button className="shine group relative w-full sm:w-auto bg-[#C9A84C] hover:bg-[#E8C878] text-[#0A0A0A] font-bold px-9 py-4 rounded-2xl text-base transition-all duration-300 hover:-translate-y-1 animate-pulse-glow">
          ...
          <button className="w-full sm:w-auto glass text-white font-semibold px-9 py-4 rounded-2xl text-base transition-all duration-300 hover:-translate-y-1 hover:bg-[#C9A84C]/10">
            View Services
          </button>
        </div>
        ...
        <div className="animate-fadeUp delay-400 flex flex-wrap justify-center gap-8 sm:gap-16">
          {[
            { value: '500+', label: 'Articles Created' },
            { value: '12+', label: 'Industries Served' },
            { value: '3–7', label: 'Days to Placement' },
          ].map((stat) => (
