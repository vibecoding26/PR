    ...
    <section className="bg-[#0A0A0A] py-24 px-4">
      <div className="max-w-5xl mx-auto">
        <div className="relative rounded-3xl overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-[#C9A84C] via-[#9A7B35] to-[#D4AF37]" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(232,200,120,0.15),transparent_60%)]" />
          ...
          <div className="relative z-10 text-center px-8 py-20 md:py-24">
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-8">
              <span className="w-1.5 h-1.5 bg-[#E8C878] rounded-full" />
              <span className="text-xs text-white/80 tracking-[0.15em] uppercase font-medium">Limited Spots</span>
            </div>

            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white mb-5 tracking-[-0.03em] leading-tight">
              Your Story Belongs <br className="hidden sm:block" />in Trusted Media
            </h2>
            <p className="text-white/65 text-lg mb-12 max-w-xl mx-auto leading-relaxed">
              Build authority with AI-powered PR content and strategic media placement. Start today.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="shine group bg-white text-[#0A0A0A] font-extrabold px-10 py-4 rounded-2xl text-base transition-all duration-200 hover:-translate-y-1 shadow-[0_8px_30px_rgba(0,0,0,0.25)] hover:shadow-[0_16px_50px_rgba(0,0,0,0.35)] flex items-center gap-2 justify-center">
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-12 text-white/50 text-sm">
              {['Editorial approval', 'AEO + SEO optimized', 'Multi-outlet distribution'].map((item) => (
